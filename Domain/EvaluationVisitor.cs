    ...
    /// <summary>
        ...
        public override void Visit(BinaryExpression expression)
        {
            ...
            switch (expression.Type)
            {
                ...
                case BinaryExpressionType.Equal when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null && r == null)
                        Result = true;
                    else if(l == null || r == null)
                        Result = false;
                    else Result = CompareUsingMostPreciseType(l,r) == 0;
                    break;

                case BinaryExpressionType.NotEqual when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null && r == null)
                        Result = false;
                    else if(l == null || r == null)
                ...
                case BinaryExpressionType.Greater when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null || r == null)
                        Result = false;
                    else Result = CompareUsingMostPreciseType(l,r) > 0;
                ...
                case BinaryExpressionType.GreaterOrEqual when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null && r == null)
                        Result = true;
                    else if(l == null || r == null)
                ...
                case BinaryExpressionType.Lesser when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null || r == null)
                        Result = false;
                    else Result = CompareUsingMostPreciseType(l,r) < 0;
                ...
                case BinaryExpressionType.LesserOrEqual when left() is var l && right() is var r:
                    // Use the type of the left operand to make the comparison
                    if(l == null && r == null)
                        Result = true;
                    else if(l == null || r == null)
